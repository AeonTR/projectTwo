Shader "Shader/Particles-Additive-Distortion-Simple" {
	Properties {
		_MainTex ("Main Texture", 2D) = "white" {}
		_Tint ("Tint Color", Vector) = (1,1,1,1)
		_DistortionTex ("Distortion Texture", 2D) = "black" {}
		_Intensity ("Color&Distort Intensity", Vector) = (1.5,1.5,0.1,0.2)
		_Speed ("Speed", Vector) = (0,0,0,0)
		[MaterialToggle] _TexBleach ("Texture Bleach", Float) = 0.3215686
