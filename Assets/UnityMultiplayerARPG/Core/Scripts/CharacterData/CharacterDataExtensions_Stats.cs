...
namespace MultiplayerARPG
{
    public static partial class CharacterDataExtensions
    {
        ...
        public static void GetBuffs(this EquipmentBonus equipmentBonus,
            System.Action<CharacterStats> onIncreasingStats,
            System.Action<CharacterStats> onIncreasingStatsRate,
            System.Action<Dictionary<Attribute, float>> onIncreasingAttributes,
            System.Action<Dictionary<Attribute, float>> onIncreasingAttributesRate,
        ...
        {
            if (onIncreasingStats != null)
                onIncreasingStats.Invoke(equipmentBonus.stats);
            if (onIncreasingStatsRate != null)
                onIncreasingStatsRate.Invoke(equipmentBonus.statsRate);
            if (onIncreasingAttributes != null)
                onIncreasingAttributes.Invoke(GameDataHelpers.CombineAttributes(equipmentBonus.attributes, new Dictionary<Attribute, float>(), 1f));
            if (onIncreasingAttributesRate != null)
                onIncreasingAttributesRate.Invoke(GameDataHelpers.CombineAttributes(equipmentBonus.attributesRate, new Dictionary<Attribute, float>(), 1f));
            if (onIncreasingResistances != null)
                onIncreasingResistances.Invoke(GameDataHelpers.CombineResistances(equipmentBonus.resistances, new Dictionary<DamageElement, float>(), 1f));
            if (onIncreasingArmors != null)
                onIncreasingArmors.Invoke(GameDataHelpers.CombineArmors(equipmentBonus.armors, new Dictionary<DamageElement, float>(), 1f));
            if (onIncreasingArmorsRate != null)
                onIncreasingArmorsRate.Invoke(GameDataHelpers.CombineArmors(equipmentBonus.armorsRate, new Dictionary<DamageElement, float>(), 1f));
            if (onIncreasingDamages != null)
                onIncreasingDamages.Invoke(GameDataHelpers.CombineDamages(equipmentBonus.damages, new Dictionary<DamageElement, MinMaxFloat>(), 1f));
            if (onIncreasingDamagesRate != null)
                onIncreasingDamagesRate.Invoke(GameDataHelpers.CombineDamages(equipmentBonus.damagesRate, new Dictionary<DamageElement, MinMaxFloat>(), 1f));
            if (onIncreasingSkills != null)
                onIncreasingSkills.Invoke(GameDataHelpers.CombineSkills(equipmentBonus.skills, new Dictionary<BaseSkill, int>(), 1f));
            if (onIncreasingStatusEffectResistances != null)
                onIncreasingStatusEffectResistances.Invoke(GameDataHelpers.CombineStatusEffectResistances(equipmentBonus.statusEffectResistances, new Dictionary<StatusEffect, float>(), 1f));
        }
            ...
            System.Action<Dictionary<StatusEffect, float>> onIncreasingStatusEffectResistances = null)
        {
            ...
            GetBuffs(tempEquipmentItem.EnchantingAttributes,
                onIncreasingStats,
                onIncreasingStatsRate,
                onIncreasingAttributes,
                onIncreasingAttributesRate,
