...
namespace MultiplayerARPG
{
    public partial class CharacterItem
    {
        ...
        [System.NonSerialized]
        private IEnchantingPaperItem _cacheEnchantingPaperItem;
        [System.NonSerialized]
        private IEnchantingCostItem _cacheEnchantingCostItem;
        [System.NonSerialized]
        ...
        private void ClearCachedData()
        {
            ...
            _cacheEnchantingPaperItem = null;
            _cacheEnchantingCostItem = null;
        ...
        private void MakeCache()
        {
            ...
            if (_cacheItem.IsEnchantingPaper())
                _cacheEnchantingPaperItem = _cacheItem as IEnchantingPaperItem;
            if (_cacheItem.IsEnchantingCost())
                _cacheEnchantingCostItem = _cacheItem as IEnchantingCostItem;
        ...
        public IEquipmentItem GetEquipmentItem()
        {
            ...
            if (_cacheEquipmentItem != null)
            {
                ...
                _cacheEquipmentItem.EnchantingAttributes = newAttr;
            }

            return this._cacheEquipmentItem;
        }
        ...
        public IEnchantingPaperItem GetEnchantingPaperItem()
        {
            MakeCache();
            return _cacheEnchantingPaperItem;
        }

        public IEnchantingCostItem GetEnchantingCostItem()
        {
            MakeCache();
            return _cacheEnchantingCostItem;
        }
