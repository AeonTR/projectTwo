namespace MultiplayerARPG
{
    public partial class GameDataMenuConsts
    {
        ...
        public const string SOCKET_ENCHANTING_PAPER_FILE = "Equipment Enchanting Paper";
        public const string SOCKET_ENCHANTING_PAPER_MENU = "Create GameData/Item/Equipment Enchanting Paper";
        public const int SOCKET_ENCHANTING_PAPER_ORDER = -5684;

        public const string SOCKET_ENCHANTING_COST_FILE = "Equipment Enchanting Cost";
        public const string SOCKET_ENCHANTING_COST_MENU = "Create GameData/Item/Equipment Enchanting Cost";
        public const int SOCKET_ENCHANTING_COST_ORDER = -5683;
