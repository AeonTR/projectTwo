...
namespace MultiplayerARPG
{
    public abstract partial class BaseEquipmentItem : BaseItem, IEquipmentItem
    {
        ...
        [SerializeField]
        private EquipmentBonus enchantingAttributes = new EquipmentBonus();
        public EquipmentBonus EnchantingAttributes
        {
            get { return enchantingAttributes; }
            set { enchantingAttributes = value; }
        }
        ...
        public override void PrepareRelatesData()
        {
            ...
            GameInstance.AddAttributes(EnchantingAttributes.attributes);
            GameInstance.AddAttributes(EnchantingAttributes.attributesRate);
            GameInstance.AddDamageElements(EnchantingAttributes.resistances);
            GameInstance.AddDamageElements(EnchantingAttributes.resistances);
            GameInstance.AddDamageElements(EnchantingAttributes.armors);
            GameInstance.AddDamageElements(EnchantingAttributes.damages);
            GameInstance.AddSkills(EnchantingAttributes.skills);
            GameInstance.AddStatusEffects(EnchantingAttributes.statusEffectResistances);
