...
namespace MultiplayerARPG
{
    public static class ItemExtensions
    {
        ...
        public static bool IsEnchantingPaper<T>(this T item)
            where T : IItem
        {
            return item != null && item.ItemType == ItemType.EnchantingPaper;
        }

        public static bool IsEnchantingCost<T>(this T item)
            where T : IItem
        {
            return item != null && item.ItemType == ItemType.EnchantingCost;
        }
