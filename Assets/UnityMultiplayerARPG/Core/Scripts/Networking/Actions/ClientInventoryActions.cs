...
namespace MultiplayerARPG
{
    public static class ClientInventoryActions
    {
        ...
        public static System.Action<ResponseHandlerData, AckResponseCode, ResponseUseEnchantingPaperMessage> onResponseUseEnchantingPaper;
        public static System.Action<ResponseHandlerData, AckResponseCode, ResponseUseEnchantingCostMessage> onResponseUseEnchantingCost;
        ...
        public static void ResponseUseEnchantingPaper(ResponseHandlerData requestHandler, AckResponseCode responseCode, ResponseUseEnchantingPaperMessage response)
        {
            ClientGenericActions.ClientReceiveGameMessage(response.message);
            if (onResponseUseEnchantingPaper != null)
                onResponseUseEnchantingPaper.Invoke(requestHandler, responseCode, response);
        }

        public static void ResponseUseEnchantingCost(ResponseHandlerData requestHandler, AckResponseCode responseCode, ResponseUseEnchantingCostMessage response)
        {
            ClientGenericActions.ClientReceiveGameMessage(response.message);
            if (onResponseUseEnchantingCost != null)
                onResponseUseEnchantingCost.Invoke(requestHandler, responseCode, response);
        }
