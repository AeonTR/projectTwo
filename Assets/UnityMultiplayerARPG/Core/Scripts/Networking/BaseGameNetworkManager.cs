    ...
    public abstract partial class BaseGameNetworkManager : LiteNetLibGameManager
    {
        ...
        protected override void RegisterMessages()
        {
            ...
            if (ServerInventoryMessageHandlers != null)
            {
                ...
                RegisterRequestToServer<RequestUseEnchantingPaperMessage, ResponseUseEnchantingPaperMessage>(GameNetworkingConsts.UseEnchantingPaper, ServerInventoryMessageHandlers.HandleRequestUseEnchantingPaper);
                RegisterRequestToServer<RequestUseEnchantingCostMessage, ResponseUseEnchantingCostMessage>(GameNetworkingConsts.UseEnchantingCost, ServerInventoryMessageHandlers.HandleRequestUseEnchantingCost);
