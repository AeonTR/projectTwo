...
namespace MultiplayerARPG
{
    public partial class DefaultClientInventoryHandlers : MonoBehaviour, IClientInventoryHandlers
    {
        ...
        public bool RequestUseEnchantingPaper(RequestUseEnchantingPaperMessage data, ResponseDelegate<ResponseUseEnchantingPaperMessage> callback)
        {
            return Manager.ClientSendRequest(GameNetworkingConsts.UseEnchantingPaper, data, responseDelegate: callback);
        }

        public bool RequestUseEnchantingCost(RequestUseEnchantingCostMessage data, ResponseDelegate<ResponseUseEnchantingCostMessage> callback)
        {
            return Manager.ClientSendRequest(GameNetworkingConsts.UseEnchantingCost, data, responseDelegate: callback);
        }
