...
namespace MultiplayerARPG
{
    public partial interface IClientInventoryHandlers
    {
        ...
        bool RequestUseEnchantingPaper(RequestUseEnchantingPaperMessage data, ResponseDelegate<ResponseUseEnchantingPaperMessage> callback);
        bool RequestUseEnchantingCost(RequestUseEnchantingCostMessage data, ResponseDelegate<ResponseUseEnchantingCostMessage> callback);
