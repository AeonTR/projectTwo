...
namespace MultiplayerARPG
{
    public partial interface IServerInventoryMessageHandlers
    {
        ...
        UniTaskVoid HandleRequestUseEnchantingPaper(
            RequestHandlerData requestHandler, RequestUseEnchantingPaperMessage request,
            RequestProceedResultDelegate<ResponseUseEnchantingPaperMessage> result);
        UniTaskVoid HandleRequestUseEnchantingCost(
            RequestHandlerData requestHandler, RequestUseEnchantingCostMessage request,
