...
namespace MultiplayerARPG
{
    public class StorageCharacterItemSerializationSurrogate : ISerializationSurrogate
    {
            ...
            StreamingContext context)
        {
            ...
            info.AddValue("enchantings", data.characterItem.enchantingDatas);
        }
            ...
            ISurrogateSelector selector)
        {
            ...
            try
            {
                characterItem.enchantingDatas = (List<EnchantingData>)info.GetValue("enchantings", typeof(List<EnchantingData>));
            }
            catch { }
