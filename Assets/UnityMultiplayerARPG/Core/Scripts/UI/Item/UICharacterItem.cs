...
namespace MultiplayerARPG
{
    public partial class UICharacterItem : UIDataForCharacter<UICharacterItemData>
    {
        ...
        public IEnchantingPaperItem EnchantingPaperItem { get { return CharacterItem != null && CharacterItem.NotEmptySlot() ? CharacterItem.GetEnchantingPaperItem() : null; } }
        public IEnchantingCostItem EnchantingCostItem { get { return CharacterItem != null && CharacterItem.NotEmptySlot() ? CharacterItem.GetEnchantingCostItem() : null; } }
        ...
        public UIEquipmentEnchanting uiEquipmentEnchanting;
        ...
        protected override void UpdateData()
        {
            ...
            if (uiEquipmentEnchanting != null)
            {
                if (EquipmentItem == null || EquipmentItem.EnchantingAttributes == null)
                {
                    // Only equipment item has equipment set data
                    uiEquipmentEnchanting.Hide();
                }
                else
                {
                    uiEquipmentEnchanting.Show();
                    uiEquipmentEnchanting.Data = new UIEquipmentEnchantingData(EquipmentItem.EnchantingAttributes, 1);
                }
            }
        ...
        #region Set Enchanting Item Functions
        /// <summary>
        /// Use this function to set item which you want to Enchanting (by socket) to `UIEnhanceSocketItem` instance
        /// </summary>
        public void OnClickSetEnchantingItem()
        {
            // Only owning character can enhance item
            if (!IsOwningCharacter())
                return;
            ...
            if (EquipmentItem != null)
            {
                GameInstance.ItemUIVisibilityManager.ShowEnchantingItemDialog(InventoryType, IndexOfData);
                if (selectionManager != null)
                    selectionManager.DeselectSelectedUI();
            }
        }
