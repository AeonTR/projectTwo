...
namespace MultiplayerARPG
{
    public partial class UISceneGameplay : BaseUISceneGameplay
    {
        ...
        [Tooltip("If this UI was not set, it will find component in children to set when `Awake`")]
        public UIEnchantingItem uiEnchantingItem;
        [Tooltip("If this UI was not set, it will find component in children to set when `Awake`")]
        ...
        public void SetUIComponentsFromChildrenIfEmpty()
        {
            ...
            if (uiEnchantingItem == null)
                uiEnchantingItem = gameObject.GetComponentInChildren<UIEnchantingItem>(true);
        ...
        public override bool IsEnchantingItemDialogVisible()
        {
            return uiEnchantingItem != null &&
                uiEnchantingItem.IsVisible();
        }
        ...
        public override void ShowEnchantingItemDialog(InventoryType inventoryType, int indexOfData)
        {
            if (uiEnchantingItem == null)
                return;
            uiEnchantingItem.Data = new UIOwningCharacterItemData(inventoryType, indexOfData);
            uiEnchantingItem.Show();
        }
