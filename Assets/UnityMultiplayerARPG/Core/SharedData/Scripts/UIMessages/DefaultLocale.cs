...
namespace MultiplayerARPG
{
    public static class DefaultLocale
    {
        ...
        static DefaultLocale()
        {
            ...
            // Error - Enchanting
            Texts.Add(UITextKeys.UI_ERROR_CANNOT_ENCHANTING_SOCKET.ToString(), "Enchanting max times");
            Texts.Add(UITextKeys.UI_ERROR_CANNOT_ENCHANTING_FAIL.ToString(), "Enchanting failed");
            Texts.Add(UITextKeys.UI_ERROR_NO_ADAPTER_ENCHANTING_BONUS.ToString(), "No adapter enchanting bonus!");
            // Error - Repair
